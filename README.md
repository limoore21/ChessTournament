...
SQL - запрос:
    ...
    Создайте базу данных и назовите ее chess_tournament(можно на свое усмотрение),
    ctrl+shift+F10 (В DataGrip) и вставте SQL-запрос, в PhpMyAdmin в колонке инструментов <SQL>,
    После установки БД поменяйте конфигурационные настройки в файле config.php, название и пароль.
