...
| Сервер | Apache / OpenServer |

---

## Структура проекта

| Структура | Изображение |
|-----------|-------------|
| Структура проекта | ![](./images/изображение.png) |
---
...
В планах на будущее
    ...
    Создание небольшого справочника на основе кода для обозревания интересных функций по типу beginTransaction(),commit(),rollBack()
